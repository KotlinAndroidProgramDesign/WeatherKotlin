package android.vv.com.weatherkotlin.util.adapter
 ...
 */
class DividerDecoration private constructor(private val mHeight: Int, private val mLPadding: Int, private val mRPadding: Int, colour: Int) : RecyclerView.ItemDecoration() {
